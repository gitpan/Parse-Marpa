...
that is,
with C<scalar @{$Parse::Marpa::This::v}>
and C<$#$Parse::Marpa::This::v>.
...
The direct availability of C<$Parse::Marpa::This::v> is temporary.
A set of convenient macros will soon be provided.
Once the macros are available, access to C<$Parse::Marpa::This::v> will
(not very conveniently, I have to admit)
be removed.
...
may be negative.  The default priority is 0.
    ...
    definition: predefined setting, period.  q{ $Parse::Marpa::This::v->[0] }.  priority 1000.
